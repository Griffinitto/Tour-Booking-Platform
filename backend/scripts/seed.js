...
const sampleData = {
  tours: [
    ...
    },
    {
      ...
      description: "Discover the Big Apple in all its glory",
    ...
    {
      id: "tour-4",
      name: "London Heritage Walk",
      description: "Walk through centuries of history in London", 
      location: "London, UK",
      price: 199,
      duration: 2,
    ...
    {
      id: "tour-6",
      name: "Sydney Harbor Experience",
      description: "Experience the beauty of Sydney Harbor",
...
// Write sample data to db.json
fs.writeFileSync(dataPath, JSON.stringify(sampleData, null, 2));

console.log('Sample data created successfully at:', dataPath);
console.log('You can now run: npm run dev:json');